"""
  This script collects the data from forward and backward switchings process and computed the absolute free energy as function of pressure
...
for l in range(len(t_sc)):
    ...
    # free energy reference value Silicon beta-tin at T=400 K and 15.0 GPa.
    G0 = -2.571583 
