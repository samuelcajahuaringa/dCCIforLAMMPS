#! /bin/bash
declare -a t_sw=('1000' '2000' '5000') #('10000' '20000' '50000' '100000' '200000' '500000' '1000000') switching time

N_sw=${#t_sw[@]}
N_sim=10
T=400 # temperature
Pi=150000.0 # initial pressure
Pf=50000.0 # final pressure # 1 GPa = 10000 bars
dt=0.001
a=6.76395
c=2.84864
