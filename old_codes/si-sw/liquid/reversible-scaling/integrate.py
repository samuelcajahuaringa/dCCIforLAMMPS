"""
  This script collects the data from forward and backward scaling process and computed the absolute free energy as function of the temperature
...
N_sim = 10
T0 = 2200   # Reference temperature [K]
Pext = 150000.0 # bars
...
# free energy reference value silicon liquid at 2200 K and 15.0 GPa.
G0 = -3.632330  
...
for j in range(0,N_sim):
    ...
    fileoutput = "free_energy_liquid_"+str(j+1)+".dat"
...
savetxt('free_energy_liquid.dat', transpose([T,G]),
        header='T(K) G(eV/atom)', fmt='%6.6f %.6f')
